...
Node* traverse(SLList* List, int index);  //return the pointer to the node previous to the node at index 
void insert(SLList* List, int index, int data); //insert a node with payload data at position index
void suppress(SLList* List, int index);  //deletes a node at position index
void pushfront(SLList* List, int data); //insert node at the front of the list
void pushback(SLList* List, int data); //insert node at the end of the list
...
void insertAsc(SLList* List, int data); //insert an element in the list in ascending order
...
Node* traverse(SLList* List, int index) {
    /*
...
void insert(SLList* List, int index, int data) {
    /*
...
void pushfront(SLList* List, int data) {
    /*
...
void pushback(SLList* List, int data) {
    /*
...
void suppress(SLList* List, int index) {
    /*
...
void sortinsert(SLList* List, Node* new_node) {
    /*
